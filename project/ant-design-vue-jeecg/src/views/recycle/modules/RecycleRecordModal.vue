  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/recycle/recycleRecord/add",
          edit: "/recycle/recycleRecord/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'orderId','createBy','createTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'orderId','createBy','createTime'))
      },
