  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/RecycleCategory/recycleCategory/add",
          edit: "/RecycleCategory/recycleCategory/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','createBy','createTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','createBy','createTime'))
      }
