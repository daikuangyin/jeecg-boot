  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/recycle/recyclePromotion/add",
          edit: "/recycle/recyclePromotion/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','phone','address','createBy','createTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','phone','address','createBy','createTime'))
      }
